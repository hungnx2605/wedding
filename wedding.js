...
const albumFull = albumPhotos.map(p => p.replace('album-thumbs', 'album-full'));
...
function submitRsvp(e, who) {
  ...
  const data = {
    ...
    attend: form.querySelector('input[name="attend-' + who + '"]:checked').value,
  };

  fetch('https://script.google.com/macros/s/AKfycbzEUcYDSl1TwKoBafrnLWw2g2CW0Ife8F6t28chsS-wQs9py3IV0kSrdyTg1ACHmzby/exec', {
    method: 'POST',
